...
<?php echo $form->errorSummary($model); ?>
	...
	<?php if($model['key']=='Services' || $model['key']=='About' || $model['key']=='Features') {
		echo $form->hiddenField($model,'key',array('value'=>$model->key));
		//echo "<table><tr><td>Key</td><td>".$model->key."</td></tr></table>";
	} else {
	...
	<?php if($model->thumb_image){ ?>
		<?php echo CHtml::image(Yii::app()->request->baseUrl.'/images/page/'.$model->thumb_image.'','image',array("style"=>"width:100px;")); ?>
	<?php } ?>
