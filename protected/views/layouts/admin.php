		...
		<div class="left-side sticky-left-side">
			...
			<div class="left-side-inner">
				<ul class="nav nav-pills nav-stacked custom-nav">
					...
					<li class="menu-list"><a href="#"><i class="lnr lnr-briefcase"></i><span>Partner</span></a>
						<ul class="sub-menu-list">
							<li><a href="<?php echo Yii::app()->createUrl('partner/create'); ?>">Create</a></li>
							<li><a href="<?php echo Yii::app()->createUrl('partner/admin'); ?>">Manage</a></li>
						</ul>
					</li>
					<li class="menu-list"><a href="#"><i class="lnr lnr-users"></i><span>Team</span></a>
						<ul class="sub-menu-list">
							<li><a href="<?php echo Yii::app()->createUrl('team/create'); ?>">Create</a></li>
							<li><a href="<?php echo Yii::app()->createUrl('team/admin'); ?>">Manage</a></li>
						</ul>
					</li>
					<li class="menu-list"><a href="#"><i class="lnr lnr-bullhorn"></i><span>News</span></a>
						<ul class="sub-menu-list">
							<li><a href="<?php echo Yii::app()->createUrl('news/create'); ?>">Create</a></li>
							<li><a href="<?php echo Yii::app()->createUrl('news/admin'); ?>">Manage</a></li>
						</ul>
					</li>
					...
					<li class="menu-list"><a href="#"><i class="lnr lnr-envelope"></i><span>Contact</span></a>
						<ul class="sub-menu-list">
							<li><a href="<?php echo Yii::app()->createUrl('contacts/admin'); ?>">Inbox</a></li>
						</ul>
					</li>
