<!-- CONTENT INDEX PAGE -->
	...
	<section id="cta" class="wow fadeIn">
		<div class="container">
			<div class="row">
				<div class="col-sm-9">
					<h2><?php echo $core1; ?></h2>
					<!-- <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p> -->
				</div>
				<div class="col-sm-3 text-right">
					<a class="btn btn-danger btn-lg btn-scroll-to" href="#about"><?php echo $core2; ?></a>
				</div>
			</div>
		</div>
	</section><!--/#cta-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-6 wow fadeInLeft">
					<h3 class="column-title"><?php echo $core3; ?></h3>
					<!-- 16:9 aspect ratio -->
				...
				<div class="col-sm-6 wow fadeInRight">
					<h3 class="column-title"><?php echo $core4; ?></h3>
					<?php echo substr($tentang->content,0,690).'...'; ?>
					<div>
						<a class="btn btn-danger" href="<?php echo Yii::app()->createUrl('about'); ?>"><?php echo $core2; ?></a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-sm-6">
					<div class="media service-box wow fadeInRight">
						<div class="pull-left">
							...
							<div>
								<a class="btn btn-danger" href="<?php echo Yii::app()->createUrl('features'); ?>"><?php echo $core2; ?></a>
							</div>
						</div>
					</div>
				</div>
	...
	<section id="work-process">
		<div class="container">
			<div class="section-header">
				<h2 class="section-title text-center wow fadeInDown"><?php echo $core5; ?></h2>
				<!-- <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p> -->
			</div>
	...
	<section id="portfolio">
		<div class="container">
			<div class="section-header">
				<h2 class="section-title text-center wow fadeInDown"><?php echo $core6; ?></h2>
				<!-- <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p> -->
			</div>
	...
	<section id="meet-team">
		<div class="container">
			<div class="section-header">
				<h2 class="section-title text-center wow fadeInDown"><?php echo $core7; ?></h2>
				<!-- <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p> -->
			</div>
			<div class="row">
	...
	<section id="blog">
		<div class="container">
			<div class="section-header">
				<h2 class="section-title text-center wow fadeInDown"><?php echo $core8; ?></h2>
				<!-- <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p> -->
			</div>
			<div class="row">
					...
					<div class="blog-post blog-large wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="0ms">
						<article>
							...
							<div class="entry-content">
								...
								<a class="btn btn-danger" href="<?php echo Yii::app()->createUrl('news/view',['id'=>$berita->id]) ?>"><?php echo $core9; ?></a>
							</div>
	...
	<section id="get-in-touch">
		<div class="container">
			<div class="section-header">
				<h2 class="section-title text-center wow fadeInDown"><?php echo $core10; ?></h2>
				<!-- <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p> -->
			</div>
		</div>
				...
				<div class="row">
					<div class="col-sm-4 col-sm-offset-8">
						<div class="contact-form">
							<h3><?php echo $core11; ?></h3>
							<address>
								<strong>PT SUPRABAKTI MANDIRI</strong><br>
								<?php echo $core12; ?>: Jl. Danau Sunter Utara Blok A No. 9, Sunter Agung, Daerah Khusus Ibukota Jakarta.<br>
								<?php echo $core13; ?>: (021) 65833666
							</address>
