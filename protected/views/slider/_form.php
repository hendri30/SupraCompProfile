...
<?php echo $form->errorSummary($model); ?>
	...
	<?php echo $form->textAreaGroup($model,'qoutes', array('widgetOptions'=>array('htmlOptions'=>array('rows'=>6, 'cols'=>50, 'class'=>'span8')))); ?>

	<?php if(!empty($model->file_name)){ ?>
		<?php echo CHtml::image(Yii::app()->request->baseUrl.'/images/slider/'.$model->file_name.'','image',array("style"=>"width:100px;")); ?>
	<?php } ?>
