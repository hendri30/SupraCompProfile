...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="images/logo.png" alt="logo" height="57px"></a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="#portfolio">Partners</a></li>
    ...
    <section id="main-slider">
        <div class="owl-carousel">
            <div class="item" style="background-image: url(images/slider/slider-coverback.png);">
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h2>It's <span>About </span>People</h2>
                                    <p>Suprabakti Empower The Best Human Resource as our commitment for best service</p>
                ...
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h2>We Care About <span>Conveyor Lifetime</span></h2>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 wow fadeInRight">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <ul class="nostyle">
                                <li><i class="fa fa-check-square"></i>Conveyor Belt Maintenance</li>
                                <li><i class="fa fa-check-square"></i>Conveyor Components</li>
                                <li><i class="fa fa-check-square"></i>Conveyor Drive</li>
                                <li><i class="fa fa-check-square"></i>Conveyor Safety Devices</li>
                        ...
                        <div class="col-sm-6">
                            <ul class="nostyle">
                                <li><i class="fa fa-check-square"></i>Conveyor Belt Rip Detection</li>
                                <li><i class="fa fa-check-square"></i>Wear and Corrosion protection</li>
                                <li><i class="fa fa-check-square"></i>Crushing and Screening</li>
                                <li><i class="fa fa-check-square"></i>Ship Mooring and Berthings</li>
                            </ul>
                        </div>
                    </div>
    ...
    <section id="features">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Leading Innovation</h2>
                <p class="text-center wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p>
            </div>
            <div class="row">
                <div class="col-sm-6 wow fadeInLeft">
                    <img class="img-responsive" src="images/front_1.png" alt="">
                </div>
                <div class="col-sm-6">
                ...
                <div class="features">
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms">
                        <div class="media service-box">
                            <div class="pull-left">
                                <img class="img-circle img-thumbnail" src="images/services/maintenance.jpg" alt="" style="max-height:120px;">
                            </div>
                            <div class="media-body">
                                <h4 class="media-heading">Conveyor Maintenance</h4>
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">
                        <div class="media service-box">
                            <div class="pull-left">
                                <img class="img-circle img-thumbnail" src="images/services/overland.jpg" alt="" style="max-height:120px;">
                            </div>
                            <div class="media-body">
                                <h4 class="media-heading">Overland Belt Installation &amp; Belt Change Out</h4>
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="200ms">
                        <div class="media service-box">
                            <div class="pull-left">
                                <img class="img-circle img-thumbnail" src="images/services/lagging.jpg" alt="" style="max-height:120px;">
                            </div>
                            <div class="media-body">
                                <h4 class="media-heading">Pulley Lagging</h4>
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            <div class="pull-left">
                                <img class="img-circle img-thumbnail" src="images/services/beltrepair.jpg" alt="" style="max-height:120px;">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
                        <div class="media service-box">
                            <div class="pull-left">
                                <img class="img-circle img-thumbnail" src="images/services/beltclamp.jpg" alt="" style="max-height:120px;">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="500ms">
                        <div class="media service-box">
                            <div class="pull-left">
                                <img class="img-circle img-thumbnail" src="images/services/surfaceprotection.jpg" alt="" style="max-height:120px;">
                            </div>
                            <div class="media-body">
            ...
            <div class="portfolio-items">
                <div class="portfolio-item customer">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="images/portfolio/freeport.png" alt="">
                ...
                <div class="portfolio-item customer">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="images/portfolio/NTT.png" alt="">
                        <div class="portfolio-info">
                            <h3>PT. Newmont Nusatenggara</h3>
                ...
                <div class="portfolio-item customer">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="images/portfolio/si.png" alt="">
                        <div class="portfolio-info">
                            <h3>PT. Semen Indonesia</h3>
                ...
                <div class="portfolio-item customer">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="images/portfolio/vale.png" alt="">
                        <div class="portfolio-info">
                            <h3>PT. Vale Indonesia</h3>
                ...
                <div class="portfolio-item customer">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="images/portfolio/ptba.png" alt="">
                        <div class="portfolio-info">
                            <h3>PT. Bukit Asam</h3>
                            Lorem Ipsum Dolor Sit
                            <a class="preview" href="images/portfolio/full.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                ...
                <div class="portfolio-item customer">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="images/portfolio/indocement.png" alt="">
                        <div class="portfolio-info">
                            <h3>PT. Indocement, Tbk</h3>
                            Lorem Ipsum Dolor Sit
                            <a class="preview" href="images/portfolio/full.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                ...
                <div class="portfolio-item customer">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="images/portfolio/wika.png" alt="">
                        <div class="portfolio-info">
                            <h3>PT., Wijaya Karya</h3>
                            Lorem Ipsum Dolor Sit
                            <a class="preview" href="images/portfolio/full.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
            ...
            <div class="row text-center">
            	...
            	<div class="col-sm-6 col-md-3">
                    <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                        <img class="img-responsive" src="images/principals/rtt.png" alt="">
                    </div>
                </div>

                <!-- <div class="col-sm-6 col-md-3">
                    <div class="center wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <img class="img-responsive" src="images/principals/tru_trac.png" alt="">
                    </div>
                </div> -->

                <div class="col-sm-6 col-md-3">
                    <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <img class="img-responsive" src="images/principals/almex.png" alt="">
                    </div>
                </div>

                <div class="col-sm-6 col-md-3">
                    <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <img class="img-responsive" src="images/principals/martin-white.png" alt="">
                    </div>
                </div>

                <div class="col-sm-6 col-md-3">
                    <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <img class="img-responsive" src="images/principals/contitech-white.png" alt="">
                    </div>
                </div>

                <div class="col-sm-6 col-md-3">
                    <div class="center wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <img class="img-responsive" src="images/principals/trelleborg.png" alt="">
                    </div>
                </div>

                <div class="col-sm-6 col-md-3">
                    <div class="center wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <img class="img-responsive" src="images/principals/lorbrand.png" alt="">
                    </div>
                </div>

                <div class="col-sm-6 col-md-3">
                    <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <img class="img-responsive" src="images/principals/mclanahan.png" alt="">
                    </div>
                </div>

                <div class="col-sm-6 col-md-3">
                    <div class="center wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <img class="img-responsive" src="images/principals/mlt.png" alt="">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <div class="team-img">
                            <img class="img-responsive" src="images/team/jimmy.png" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Jimmy Hadinata</h3>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                        <div class="team-img">
                            <img class="img-responsive" src="images/team/gm.png" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Soesanto Houtama</h3>
                            <span>Sales General Manager</span>
                        </div>
                        <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                        <ul class="social-icons">
                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="200ms">
                        <div class="team-img">
                            <img class="img-responsive" src="images/team/ricky.png" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Ricky Djendakang</h3>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
                        <div class="team-img">
                            <img class="img-responsive" src="images/team/unknown.jpg" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Susanto Houtama</h3>
                            <span>UI/UX</span>
                        </div>
                        <p>Backed by some of the biggest names in the industry, Firefox OS is an open platform that fosters greater</p>
                        <ul class="social-icons">
                        ...
                        <article>
                            <header class="entry-header">
                                <div class="entry-thumbnail">
                                    <img class="img-responsive" src="images/blog/csr.jpg" alt="">
                                    <span class="post-format post-format-video"><i class="fa fa-film"></i></span>
                                </div>
                                <div class="entry-date">25 November 2015</div>
                                <h2 class="entry-title"><a href="#">Suprabakti Mandiri CSR News</a></h2>
                            </header>
                ...
                <div class="col-sm-6">
                    <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="100ms">
                        <article class="media clearfix">
                            <div class="entry-thumbnail pull-left">
                                <img class="img-responsive" src="images/blog/meeting.jpg" alt="">
                                <span class="post-format post-format-gallery"><i class="fa fa-image"></i></span>
                            </div>
                            <div class="media-body">
                                <header class="entry-header">
                                    <div class="entry-date">01 December 2015</div>
                                    <h2 class="entry-title"><a href="#">Strategic Meeting 2015</a></h2>
                                </header>
                    ...
                    <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="200ms">
                        <article class="media clearfix">
                            ...
                            <div class="media-body">
                                <header class="entry-header">
                                    <div class="entry-date">03 November 2015</div>
